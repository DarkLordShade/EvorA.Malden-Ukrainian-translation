...
[[EVOR_var_SideFriendly,"HQ"],format ["Ворожi сили наближайються до %1; готуйтеся вiдбивати!",markerText _mainBaseMarker]] remoteExecCall ["sideChat",EVOR_var_SideFriendly,false];
