...
private _actionScript = {["Open",false] spawn BIS_fnc_arsenal;};

private _actionID = _box addAction ["",_actionScript,nil,-4,true,true,"",_actionCond,15];
_box setUserActionText [_actionID,"Арсенал","<t size='2.5'><img image='a3\ui_f\data\IGUI\Cfg\Actions\gear_ca.paa'/></t>"];
